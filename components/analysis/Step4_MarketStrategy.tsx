...
const Step4_MarketStrategy: React.FC = () => {
    ...
    const handleCheckboxChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        updateFormData(4, { [fieldName]: newValues });
    ...
    const handleBlur = (e: React.FocusEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>) => {
        ...
        if (field?.isRequired && (!value || value.trim() === '')) {
            ...
            setErrors(prev => ({
                ...prev,
                [name]: `${field.label} must be greater than 0`
            }));
        } else if (field?.mustBeBetween0And100 && value && (parseFloat(value) < 0 || parseFloat(value) > 100)) {
            setErrors(prev => ({
                ...prev,
                [name]: `${field.label} must be between 0 and 100`
            }));
            ...
            setErrors(prev => ({
                ...prev,
                [name]: `${field.label} must be no more than ${field.maxLength} characters`
            }));
        }
    };
    ...
    return (
        <div>
            <h2 className="text-2xl font-bold mb-6">Market & Strategy</h2>
            <div className="t("auto.Step1_BasicInfo.eeefd75c")">
                {templateFields
                    .filter(field => field.stageNumber === 4)
                    .map(field => {
...
export default Step4_MarketStrategy;