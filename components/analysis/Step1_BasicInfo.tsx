...
const CheckboxGroup = ({ label, options, name, selected, onChange, error, required = false }: CheckboxGroupProps) => (
    <div className="step1-checkbox-group">
        ...
        <div className="step1-checkbox-options">
            {options.map(option => (
...
const Step1_BasicInfo: React.FC = () => {
    ...
    const handleCheckboxChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        updateFormData(1, { [fieldName]: newValues });
    ...
    return (
        <div>
            <h2 className="text-2xl font-bold mb-6">{t('analysis.step1Title')}</h2>
            <div className="step1-template-fields">
                {templateFields
                    .filter(field => field.stageNumber === 1)
                    .map(field => {
