...
const AdminLayout: React.FC = () => {
  const { language } = useLanguage();
    ...
    const adminNavLinks = [
        { to: "/admin/overview", icon: LayoutDashboard, text: "t("auto.AdminLayout.3b878279")" },
        { to: "/admin/users", icon: Users, text: "t("admin.users")" },
        { to: "/admin/templates", icon: FileText, text: "t("admin.templates")" },
        { to: "/admin/website", icon: Globe, text: "t("admin.website")" },
        { to: "/admin/settings", icon: Settings, text: "t("admin.settings")" },
        { to: "/admin/logs", icon: History, text: "t("admin.activityLogs")" },
    ];
        ...
        <div className="min-h-screen bg-background">
            ...
            <div className="pt-[70px] max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="t("auto.AdminLayout.b10df59b")">
                    ...
                    <p className="text-text-secondary mt-1">Manage your business analysis platform</p>
                </div>
