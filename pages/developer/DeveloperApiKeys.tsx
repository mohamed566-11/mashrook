        ...
        <div className="t("auto.AdminLayout.6adb5be9")">
            <div className="flex justify-between items-center mb-8">
                <div>
                    ...
                    <p className="text-gray-600 mt-1">Manage all API keys and service integrations</p>
                </div>
                <button
            ...
            {showNewKeyForm && (
                <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6">
                    <h2 className="text-lg font-semibold text-gray-800 mb-4">Create New API Key</h2>
                    <div className="t("auto.ConfirmationModal.1904562d")">
                        <input
                            type="t("auto.Program.1cb251ec")"
                            placeholder="t("auto.DeveloperApiKeys.f00db52e")"
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div className="flex rtl:justify-start space-x-2">
                                            <button
                                                ...
                                                title={apiKey.status === 'active' ? "t("auto.DeveloperApiKeys.ff7da797")" : "t("auto.DeveloperApiKeys.172869cc")"}
                                            >
                                                <Edit size={16} />
                                            </button>
                                            <button
                                                ...
                                                title="t("auto.DeveloperApiKeys.5254cc38")"
                                            >
                                                <Trash2 size={16} />
                                            </button>
                                        </div>
